...
public class PublicMediaAliasController {
    private final MediaLibraryUseCase mediaLibraryUseCase;
    private final PublicMediaUrlService publicMediaUrlService;

    public PublicMediaAliasController(MediaLibraryUseCase mediaLibraryUseCase, PublicMediaUrlService publicMediaUrlService) {
        this.mediaLibraryUseCase = mediaLibraryUseCase;
        this.publicMediaUrlService = publicMediaUrlService;
    }

    @GetMapping("/{mediaId}")
    public ResponseEntity<MediaWithVariantsResponse> getMedia(@PathVariable String mediaId,
    ...
    public ResponseEntity<MediaResolveResponse> resolve(@PathVariable String mediaId,
                                                        @RequestParam("applicationId") String applicationId,
