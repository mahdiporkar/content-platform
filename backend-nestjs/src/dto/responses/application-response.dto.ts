export class ApplicationResponseDto {
  constructor(
    ...
    public managementToken: string | null,
    public managementTokenPreview: string | null,
    public managementTokenCreatedAt: string | null,
    public managementTokenLastRotatedAt: string | null,
    public managementTokenLastUsedAt: string | null,
